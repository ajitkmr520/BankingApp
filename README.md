For initial run code we need to install MySQl and create database As per your choice i.e. Atm card details and as now to create database using cmd MySQl is given readme file.pdf
